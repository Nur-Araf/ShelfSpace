      ...
      <div className="max-w-[25rem] md:max-w-2xl lg:max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 md:pt-6 lg:pt-12">
        {books.map((book, index) => (
          ...
          >
            ...
            <p className="text-gray-400 mb-2">Rating: {book.rating}</p>
            <Link to={`/update-book/${book._id}`} className="bg-blue-500 text-white py-2 px-4 rounded-md flex items-center justify-center hover:bg-blue-600 transition duration-300">
